    	...
    	<div id="admin">
                                ...
                                <dd>
                                    <a href="#" class="dd-item dd-item-active">当前学期可评价课程<span class="scm dd-ar"></span></a>
                                     <ul class="ad-item-list">
                                        <li class="J_menuItem" href="<%=basePath%>student/getCurrentCourse" data-index="0">当前学期可评价课程</li>
                                    </ul>
                                </dd>
                                <dd>
                                    <a href="#" class="dd-item">历史评价<span class="scm dd-ar"></span></a>
                                    <ul class="ad-item-list">
                                        <li class="J_menuItem" href="<%=basePath%>student/getHistoryCourse" data-index="4">历史评价</li>
                                    </ul>
                                </dd>
                            </dl>
                        </li>
                        <li>
                            ...
                            <dl>
                                <dd>
                                    ...
                                    <ul class="ad-item-list">
                                        <li class="J_menuItem" href="<%=basePath%>student/getCurrentCourseToComplain" data-index="5">当前学期可投诉课程</li>
                                    </ul>
                                </dd>
                            </dl>
                        </li>
                        <li>
                            ...
                            <dl>
                                <dd>
                                    ...
                                    <ul class="ad-item-list">
                                        <li class="J_menuItem" href="<%=basePath%>view/student/updatePassword.jsp" data-index="2">更改密码</li>
                                    </ul>
                                </dd>
                                <dd>
                                    <a href="#" class="dd-item">重置密码<span class="scm dd-ar"></span></a>
                                	<ul class="ad-item-list">
                                        <li class="J_menuItem" href="<%=basePath%>view/student/reset.jsp" data-index="3">重置密码</li>
                                    </ul>
                                </dd>
                            </dl>
                        </li>
    		...
    		<div class="ad-comment-box" id="ad-comment">
                            ...
                            <div class="ad-welcom">
                                <div class="ad-wel-text">
                                    <div class="font-wel"><a href="javascript:;"><strong>
                                        <form action="<%=basePath%>/student/logout" method="post">
                    ...
                    <div class="ad-sub-nav-box content-tabs">
                        ...
                        <div class="ad-sub-wraper page-tabs J_menuTabs">
                            <ul class="ad-sub-list page-tabs-content">
                                <li class="active J_menuTab" data-id="<%=basePath%>student/getCurrentCourse">当前学期课评价课程</li>
                            </ul>
                        </div>
                ...
                <div class="ad-main-comment J_mainContent" id="ad-iframe">
                    <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="<%=basePath%>student/getCurrentCourse" frameborder="1" data-id="<%=basePath%>student/getCurrentCourse" seamless></iframe>
                </div>
    		</div>
    	</div>
