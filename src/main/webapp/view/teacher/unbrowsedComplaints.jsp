...
<a href="<%=basePath%>view/teacher/admin.jsp"><button class="btn btn-look btn-xs btna" data-toggle="modal" data-target="#reviseUser">返回首页</button></a>
</body>
<script type="text/javascript">
    function jump(){
        window.location.href="<%=basePath%>view/teacher/complaintInfo.jsp";
    }
</script>
