...
<form action="<%=basePath%>admin/searchTeacherByCondition" method="get">
    ...
    <div class="data-div">
        ...
        <div class="tablebody">
            <div class="row">
                ...
                <div class="col-xs-2">
                    <form action="<%=basePath%>admin/updateSingleTeacher?teacherId=<%=teachId%>" method="post">
                    </form>
                    <table>
                        <tr>
                            <form action="<%=basePath%>admin/updateSingleTeacher?teacherId=<%=teachId%>" method="post">
                        ...
                        <tr>
                            <form action="<%=basePath%>admin/deleteSingleTeacher?teacherId=<%=teachId%>" method="post">
...
<form action="<%=basePath%>admin/searchTeacherByCondition?pageNow=1&teacherType=${teacher.teacherType}&monitorType=${teacher.monitorType}&leaderType=${teacher.leaderType}&title=${teacher.title}" method="post">
    <button class="btn btn-look btn-xs" data-toggle="modal" data-target="#reviseUser">首页</button>
</form>
<c:choose>
    <c:when test="${page.pageNow - 1 > 0}">
        <form action="<%=basePath%>admin/searchTeacherByCondition?pageNow=${page.pageNow - 1}&teacherType=${teacher.teacherType}&monitorType=${teacher.monitorType}&leaderType=${teacher.leaderType}&title=${teacher.title}" method="post">
...
<c:choose>
    <c:when test="${page.totalPageCount==0}">
        <form action="<%=basePath%>admin/searchTeacherByCondition?pageNow=${page.pageNow}&teacherType=${teacher.teacherType}&monitorType=${teacher.monitorType}&leaderType=${teacher.leaderType}&title=${teacher.title}" method="post">
    ...
    <c:when test="${page.pageNow + 1 >= page.totalPageCount}">
        <form action="<%=basePath%>admin/searchTeacherByCondition?pageNow=${page.totalPageCount}&teacherType=${teacher.teacherType}&monitorType=${teacher.monitorType}&leaderType=${teacher.leaderType}&title=${teacher.title}" method="post">
            <button class="btn btn-look btn-xs" data-toggle="modal" data-target="#reviseUser">下一页</button>
        </form>
    </c:when>
</c:choose>
