    ...
    <div class="data-div">
        ...
        <div class="tablebody">
            <div class="row">
                ...
                <div class="col-xs-2">
                    <s:form action="<%=basePath%>admin/updateSingleStudent?studentId=${item.studentId}" method="post">
                    </s:form>
                    <table>
                        <tr>
                            <s:form action="<%=basePath%>admin/updateSingleStudent?studentId=${item.studentId}" method="post">
                        ...
                        <tr>
                            <s:form action="<%=basePath%>admin/deleteSingleStudent?studentId=${item.studentId}" method="post">
...
<font size="2">共 ${page.totalPageCount} 页</font> <font size="2">第${page.pageNow} 页</font>
    <form action="<%=basePath%>admin/searchStudentByCondition?pageNow=1&grade=${student.grade}&department=${student.department}&classId=${student.classId}" method="post">
        <button class="btn btn-look btn-xs" data-toggle="modal" data-target="#reviseUser">首页</button>
    </form>
<c:choose>
    <c:when test="${page.pageNow - 1 > 0}">
        <form action="<%=basePath%>admin/searchStudentByCondition?pageNow=${page.pageNow - 1}&grade=${student.grade}&department=${student.department}&classId=${student.classId}" method="post">
...
<c:choose>
    <c:when test="${page.totalPageCount==0}">
        <form action="<%=basePath%>admin/searchStudentByCondition?pageNow=${page.pageNow}&grade=${student.grade}&department=${student.department}&classId=${student.classId}" method="post">
    ...
    <c:when test="${page.pageNow + 1 >= page.totalPageCount}">
        <form action="<%=basePath%>admin/searchStudentByCondition?pageNow=${page.totalPageCount}&grade=${student.grade}&department=${student.department}&classId=${student.classId}" method="post">
            <button class="btn btn-look btn-xs" data-toggle="modal" data-target="#reviseUser">下一页</button>
        </form>
    </c:when>
</c:choose>
